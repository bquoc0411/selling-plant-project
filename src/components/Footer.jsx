  ...
  return (
    <footer>
      <div className="container py-5">
        <div className="row">
          <div className="col-lg-4 text-center mb-5">
            ...
            <div className="d-flex justify-content-evenly">
              <div className="network-icon px-2 py-2 d-flex align-items-center justify-content-center">
                <FaFacebookF />
              </div>
              <div className="network-icon px-2 py-2 d-flex align-items-center justify-content-center">
                <AiFillInstagram />
        ...
        <div className="text-center short-description">© 2023 GREENMIND. All right reserved</div>
      </div>
    </footer>
  );
}
